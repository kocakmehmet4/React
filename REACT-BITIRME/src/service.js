...
export const getAllByModal = createAsyncThunk(
  "cars/getAllByModal",
  async (modal) => {
...
export const getAllByModalAndByBrand = createAsyncThunk(
  "cars/getAllByModalAndByBrand",
  async (modalAndBrand) => {
    const data = await axios.get(
      `/cars?brand=${modalAndBrand.brand}&modal=${modalAndBrand.modal}`
    );
    return data.data.data;
  }
);

export const getByCarIdCars = createAsyncThunk(
  "cars/getByCarIdCars",
  async (carsId) => {
...
export const getByCarsUserId = createAsyncThunk(
  "cars/getByCarsUserId",
  async (userId) => {
